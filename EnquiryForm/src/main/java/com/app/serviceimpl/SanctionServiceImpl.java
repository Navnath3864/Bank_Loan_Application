...
public class SanctionServiceImpl implements SanctionService {
	...
	public CustomerLoanApplication sanctionLetter(int customerLoanID, SanctionLetter letter) {
		...
		if (customerLoanApplication != null) {
			...
			customerLoanApplication.getSanctionLetter()
					.setContactDetails(customerLoanApplication.getCustomerMobileNumber());
			customerLoanApplication.getSanctionLetter().setProducthomeEquity(letter.getProducthomeEquity());
			customerLoanApplication.getSanctionLetter().setLoanAmtSanctioned(letter.getLoanAmtSanctioned());
			customerLoanApplication.getSanctionLetter().setInterestType(letter.getInterestType());
			customerLoanApplication.getSanctionLetter().setRateOfInterest(letter.getRateOfInterest());
			customerLoanApplication.getSanctionLetter().setLoanTenureInMonth(letter.getLoanTenureInMonth());
			customerLoanApplication.getSanctionLetter().setMonthlyEmiAmount(letter.getMonthlyEmiAmount());
			customerLoanApplication.getSanctionLetter().setModeOfPayment(letter.getModeOfPayment());
			customerLoanApplication.getSanctionLetter().setRemarks(letter.getRemarks());
			customerLoanApplication.getSanctionLetter().setTermsCondition(letter.getTermsCondition());
			customerLoanApplication.getSanctionLetter().setStatus(letter.getStatus());
			...
			Image img = null;
			try {
				img = Image.getInstance("C://Users//DELL-PC//Pictures//Saved Pictures//download.jpg");
